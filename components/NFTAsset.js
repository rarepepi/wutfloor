...
const NFTAsset = (props) => {
    return (
        <div className="flex px-4 justify-center">
            <Fade>
            <div className="flex flex-col justify-center text-center text-white shadow-2xl w-64 h-64 motion-safe:hover:scale-110 border-2 border-purple-400 rounded-xl my-8">

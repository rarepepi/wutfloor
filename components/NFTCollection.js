...
const NFTCollection = (props) => {
    ...
    return (
        ...
        <Fade>
            <>
                <tr className="flex flex-row text-left space-x-32  text-white rounded-xl lg:pt-8 p-4">
                    <td className="flex align-middlew-40  h-16 hover:cursor-pointer">
                    ...
                    <td className="flex align-middlew-40 flex-col ">
                    ...
                    <td className="flex flex-col w-40">
                        <p className="text-white text-left">
                            <img src="https://storage.opensea.io/files/6f8e2979d428180222796ff4a33ab929.svg" className="h-4 w-4" />

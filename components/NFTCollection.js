    ...
    return (
        ...
        <Fade>
            <td className=" flex flex-row align-middle" >
                <img className="w-8 h-8 rounded-full inline-block" src={props.collection.image_url}></img>
            ...
            <td className=" align-middle">
                <p className="text-white hover:text-green-300">
                    Ξ  
                    {(Math.round((props.collection.stats.one_day_volume) * 100) / 100).toLocaleString()}</p>
            ...
            <td className=" align-middle">
                <p className="text-white hover:text-green-300">
                    Ξ  
                    {(Math.round((props.collection.stats.total_supply * props.collection.stats.average_price) * 100) / 100).toLocaleString()}</p>
            ...
            <td className=" align-middle">
                {props.collection.stats.one_day_change >= 0 ? <p className="text-white text-sm bg-primary text-center hover:text-green-300 rounded-2xl h-8 p-2">{Math.round(props.collection.stats.one_day_change * 100) / 100}%</p>
                    : <p className="bg-danger text-white text-center text-sm rounded-2xl h-8 p-2">{Math.round(props.collection.stats.one_day_change * 100) / 100}%</p>}
            </td>

            ...
            {loading ? <div className="flex flex-col h-screen justify-center items-center"><>
                ...
                <div>
                    ...
                    <div className="flex flex-col justify-center" >
                        <img className="rounded-full mx-auto -m-16 h-32" src={collection.image_url}></img>
                        <h1 className="text-white font-bold  text-xl mt-16 p-4 mb-1 text-center" >
                            {collection.name}'s
                        </h1>
                        <p className="text-white my-4 text-center ">Floor: Ξ <span className="text-green-400">{Math.round(collection.stats.floor_price * 100) / 100}</span></p>
                            ...
                            <div className="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 grid-cols-1 p-8">
                                ...
                                <div className="flex flex-col justify-center text-center lg:p-8 p-4 shadow-2xl">
                                    ...
                                    <div className="flex flex-col jusitfy-center text-center space-x-2">
                                        <p className="text-white mt-4 ">Price: Ξ <span className="text-green-400">{Math.round(collection.stats.one_day_volume * 100) / 100}</span></p>
                                ...
                                <div className="flex flex-col justify-center text-center lg:p-8 p-4 shadow-2xl">
                                    ...
                                    <div className="flex flex-col jusitfy-center text-center space-x-2">
                                        <p className="text-white mt-4 ">Price: Ξ <span className="text-green-400">{Math.round(collection.stats.seven_day_volume * 100) / 100}</span></p>
                                        ...
                                        <p className="text-white mt-4 ">Avg: <span className="text-green-400"> Ξ {Math.round(collection.stats.seven_day_average_price * 100) / 100}</span></p>
                                    </div>
                                ...
                                <div className="flex flex-col justify-center text-center lg:p-8 p-4 shadow-2xl">
                                    ...
                                    <div className="flex flex-col jusitfy-center text-center space-x-2">
                                        <p className="text-white mt-4 ">Price: Ξ <span className="text-green-400">{Math.round(collection.stats.thirty_day_volume * 100) / 100}</span></p>
                                        ...
                                        <p className="text-white mt-4 ">Avg: <span className="text-green-400"> Ξ {Math.round(collection.stats.thirty_day_average_price * 100) / 100}</span></p>
                                    </div>
                                ...
                                <div className="flex flex-col justify-center text-center lg:p-8 p-4 shadow-2xl">
                                    ...
                                    <div className="flex flex-col jusitfy-center text-center space-x-2">
                                        <p className="text-white mt-4 ">MKT Cap: Ξ <span className="text-green-400">{Math.round(collection.stats.total_volume * 100) / 100}</span></p>
                                        ...
                                        <p className="text-white mt-4 ">Hisorial Avg: Ξ <span className="text-green-400"> {Math.round(collection.stats.average_price * 100) / 100}</span></p>
                                        <p className="text-white mt-4 ">MKT Cap Avg: Ξ <span className="text-green-400"> {Math.round(collection.stats.market_cap * 100) / 100}</span></p>
